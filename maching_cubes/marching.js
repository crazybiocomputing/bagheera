...
var imp=document.getElementById("myImg");

var stack=imp.getElementById("myStack");//Récupérer le stack d'images compri dans myImg

var nx=imp.naturalWidth();
var ny=imp.naturalHeight();
var nz=imp.length();
...
function createTriangles(probe) {
  ...
  for (var i=0;i<edges.length;i++) {
    ...
    //console.log ("faces["+(mesh.faces.length-1)+"]= "+index);
    }
